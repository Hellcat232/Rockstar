document.addEventListener('DOMContentLoaded', function () {
  ...
  const scrollSpeed = 2; // змінна для зменшення швидкості прокрутки
  ...
  function scrollDown() {
    scrollSmoothly(swiper, swiper.scrollTop + (swiper.scrollHeight - swiper.scrollTop) / scrollSpeed);
...
function scrollUp() {
  ...
  function scrollSmoothly(element, to) {
    const duration = 500; // час прокрутки в мілісекундах
