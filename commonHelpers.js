...
`)}function D(t){const e=M(t);s.categories.insertAdjacentHTML("beforeend",e)}function N(t){return t.map(({list_name:e,books:o})=>{let r;return window.innerWidth>=1440?r=b(o,e):window.innerWidth>=768?r=b(o.slice(0,3),e):r=b(o.slice(0,1),e),`
      ...
      `}).join(`
`)}function O(t){const e=N(t);s.bestBooks.insertAdjacentHTML("beforeend",e)}function b(t,e){return t.filter(({list_name:o})=>o===e).map(({author:o,list_name:r,book_image:n,title:a,_id:u})=>`
...
`)}
  ...
  `}function w(t){const e=_(t);s.bestBooks.innerHTML=e}function E(t){const e=t.split(" "),o=e.slice(-1),n=`<h1 class="best-books-title">${e.slice(0,-1).join(" ")} <span class="best-books-title-colour">${o.join(" ")}</span></h1>`;s.categoryTitle.innerHTML=n}async function B(){const t=await A(),e=await $();D(t),O(e),s.oneCategory=document.querySelector(".sidebar-category-link"),s.categoriesItems=document.querySelectorAll(".sidebar-categories-item"),s.allCategories.classList.add("sidebar-active"),s.categories.addEventListener("click",x),s.seeMoreBtn.addEventListener("click",j)}async function j(t){const e=await L(S(t));w(e),E(S(t))}async function x(t){h(t)==="All categories"&&B();const e=await L(h(t));w(e),E(h(t)),R(t)}document.querySelector(".best-books-category");document.addEventListener("DOMContentLoaded",function(){});function U(){s.headerMenu.classList.toggle("hidden"),s.burgerSvg.getAttribute("href")=="../img/header/symbol-defs.svg#icon-burger"?(s.burgerSvg.setAttribute("href","../img/header/symbol-defs.svg#icon-close"),s.headerIcon.setAttribute("width","18"),s.headerIcon.setAttribute("height","18"),s.headerMenu.style.padding="5px"):(s.burgerSvg.setAttribute("href","../img/header/symbol-defs.svg#icon-burger"),s.headerIcon.setAttribute("width","28"),s.headerIcon.setAttribute("height","28"))}function W(t){t.preventDefault(),localStorage.removeItem("colorScheme"),s.root.classList.toggle("dark"),s.root.classList.contains("dark")?localStorage.setItem("colorScheme","dark"):localStorage.setItem("colorScheme","light")}function P(){localStorage.getItem("colorScheme"),localStorage.getItem("colorScheme")=="dark"?(s.root.classList.add("dark"),s.headerToggle.checked=!0):(s.root.classList.remove("dark"),s.headerToggle.checked=!1)}document.addEventListener("DOMContentLoaded",function(){const t=document.querySelectorAll(".item-charity"),e=document.querySelector(".btn-scroll-up"),o=document.querySelector(".btn-scroll-down"),r=document.querySelector(".swiper"),n=2;T(0,5),o.addEventListener("click",a),e.addEventListener("click",u);function a(){k(r,r.scrollTop+(r.scrollHeight-r.scrollTop)/n),o.classList.add("hidden"),e.classList.remove("hidden")}function u(){k(r,0),o.classList.remove("hidden"),e.classList.add("hidden")}function T(i,g){for(let l=i;l<=g;l++)t[l].classList.remove("hidden")}function k(i,g){const y=i.scrollTop,C=g-y,f=20;function q(c,d,p,I){return c/=I/2,c<1?p/2*c*c+d:(c--,-p/2*(c*(c-2)-1)+d)}function v(c){c+=f;const d=q(c,y,C,500);i.scrollTop=d,c<500&&setTimeout(function(){v(c)},f)}v(0)}});document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(".charity-image").forEach(e=>{e.addEventListener("click",()=>{const o=e.getAttribute("data-url");window.open(o,"_blank")})})});const s={bestBooks:document.querySelector(".best-books-category"),categories:document.querySelector(".sidebar-categories"),allCategories:document.querySelector(".sidebar-all-categories"),categoryTitle:document.querySelector(".best-books-title"),modalWindow:document.querySelector("modal-window"),seeMoreBtn:document.querySelector(".best-books-category"),headerBtn:document.querySelector(".header-burger-btn"),headerIcon:document.querySelector(".header-burger-icon"),headerMenu:document.querySelector(".header-modal-menu"),burgerSvg:document.querySelector("#burger-svg"),headerToggle:document.querySelector("#headerToggle"),root:document.querySelector(":root")};B();booksEl.addEventListener("click",clickItem);s.headerBtn.addEventListener("click",U);s.headerToggle.addEventListener("change",W);P();
