import{r as s,s as f,a as T,b as $}from"./assets/check-page-56412e9c.js";import{a as p,b as E,i as C}from"./assets/vendor-cd34f230.js";const u="https://books-backend.p.goit.global/books/",b={"Content-Type":"application/json","Cache-Control":"max-age=1300"};async function B(){const e="category-list";try{const o=`${u}${e}`;return(await p.get(o,{headers:b})).data}catch(o){console.log(o)}}async function S(){const e="top-books";try{const o=`${u}${e}`;return(await p.get(o,{headers:b})).data}catch(o){console.log(o)}}async function k(e){const o=`category?category=${e}`;try{const t=`${u}${o}`;return(await p.get(t,{headers:b})).data}catch(t){console.log(t)}}function x(e){return e.map(o=>`<li class="sidebar-categories-item"><a class="sidebar-category-link">
   ${o.list_name}
   </a>
  </li>`).join(`
`)}function _(e){const o=x(e);s.categories.insertAdjacentHTML("beforeend",o)}function q(e){return e.map(({list_name:o,books:t})=>{let n;return window.innerWidth>=1440?n=d(t,o):window.innerWidth>=768?n=d(t.slice(0,3),o):n=d(t.slice(0,1),o),`
      ...
      `}).join(`
`)}function A(e){const o=q(e);s.bestBooks.insertAdjacentHTML("beforeend",o)}function d(e,o){return e.filter(({list_name:t})=>t===o).map(({author:t,list_name:n,book_image:a,title:i,_id:c})=>`
  ...
  <div class="hardcover-wrap">
    <ul class="hardcover-list">
      ${e.map(({author:o,list_name:t,book_image:n,title:a,_id:i})=>`
          ...
          <img class="hardcover-img" src="${n}" alt="card">
...
`)}
  ...
  `}function y(e){const o=j(e);s.bestBooks.innerHTML=o}function w(e){if(!e)return;let o;if(e==="All categories")o=`<h1 class="best-books-title">
    Best Sellers<span class="best-books-title-colour"> Books</span>
  </h1>`,s.categoryTitle.innerHTML=o;else{const t=e.split(" "),n=t.slice(-1);o=`<h1 class="best-books-title">${t.slice(0,-1).join(" ")} <span class="best-books-title-colour">${n.join(" ")}</span></h1>`,s.categoryTitle.innerHTML=o}}function h(e){e.forEach(o=>{const t=document.getElementById(o._id);t&&t.addEventListener("click",n=>{n.preventDefault(),console.log(`${o._id} clicked`);function a(i){const c=E.create(`
          <div class="modal">
        ...
        `,{onShow:()=>{document.addEventListener("keydown",m)},onClose:()=>{document.body.style.overflow="auto",document.removeEventListener("keydown",m)}});c.show(),document.body.style.overflow="hidden";function m(l){console.log(l.code),l.code==="Escape"&&c.close()}document.querySelector(".modal-close-btn").addEventListener("click",l=>{c.close()})}a(o),document.querySelector(".add-to-sl-button").addEventListener("click",i=>{f(o._id)?(T(o._id),document.querySelector(".book-added-text").style.display="none",document.querySelector(".add-to-sl-button").textContent="Add to shopping list"):($(o),document.querySelector(".book-added-text").style.display="block",document.querySelector(".add-to-sl-button").textContent="Remove from the shopping list")})})})}async function L(){s.loader.classList.remove("hidden"),s.loader1.classList.remove("hidden");try{const e=await B(),o=await S();_(e),A(o),s.loader.classList.add("hidden"),s.loader1.classList.add("hidden");let t=o.flatMap(n=>n.books).filter((n,a,i)=>i.indexOf(n)===a);h(t)}catch(e){g(e)}s.oneCategory=document.querySelector(".sidebar-category-link"),s.categoriesItems=document.querySelectorAll(".sidebar-categories-item"),s.allCategories.classList.add("sidebar-active"),s.categories.addEventListener("click",M),document.querySelectorAll(".btn-see-more").forEach(e=>{e.addEventListener("click",I)})}async function I(e){s.loader1.classList.remove("hidden");try{const o=await k(v(e));y(o),w(v(e)),s.loader1.classList.add("hidden"),s.scrollToEl.scrollIntoView({behavior:"smooth"}),h(o)}catch(o){g(o)}}async function M(e){if(r(e)!==void 0){s.loader.classList.remove("hidden");try{const o=await k(r(e));console.log(r(e)),r(e)==="All categories"&&L(),y(o),w(r(e)),console.log(r(e)),R(e),s.loader.classList.add("hidden"),window.innerWidth<1440&&s.scrollToEl.scrollIntoView({behavior:"smooth"}),h(o)}catch(o){g(o)}}}function g(e){throw C.warning({title:"Caution",message:`Error: ${e}`,position:"topRight"}),e}function P(){window.addEventListener("scroll",o);let e=window.pageYOffset;function o(){window.scrollY>200?s.btnToTop.classList.add("show"):s.btnToTop.classList.remove("show");const n=window.pageYOffset;e>n?document.querySelector(".header-container").style.top="0":document.querySelector(".header-container").style.top="-118px",e=n}s.btnToTop.addEventListener("click",t);function t(){window.scrollY!=0&&setTimeout(function(){window.scrollTo(0,window.scrollY-70),t()},10)}}L();P();
